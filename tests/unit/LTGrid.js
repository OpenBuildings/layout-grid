$(function () {
    ...
    QUnit.test('Constructor with default options', function () {
    ...
    QUnit.test('Constructor with custom options and modifiable options', function () {
    ...
    QUnit.test('windowWidth method', function () {
    ...
    QUnit.test('size method', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
    ...
    QUnit.test('ghost setter / getter', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
        var $widget = $('#rect1');
    ...
    QUnit.test('compact method', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
        lt_grid.windowWidth = function () { return 1500; };
        lt_grid.compact();
    ...
    QUnit.test('update method without any options', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
    ...
    QUnit.test('moveGhost method', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
        var $widget = $('#rect1');
        var $ghost = lt_grid.ghost($widget);
        lt_grid.windowWidth = function () { return 1500; };
    ...
    QUnit.test('mask getter / setter', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
    ...
    QUnit.test('end method', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
        var $widget = $('#rect1');
    ...
    QUnit.test('grid getter / setter', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
    ...
    QUnit.test('reposition method', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
        var $widget = $('#rect1');
    ...
    QUnit.test('reposition method without overlap ', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
    ...
    QUnit.test('moveToGhost method', function () {
        var lt_grid = new $.fn.lt_grid.Constructor($('#container1'), $.fn.lt_grid.Constructor.DEFAULTS);
        var $widget = $('#rect1');
        lt_grid.windowWidth = function () { return 1500; };
        var $ghost = lt_grid.ghost($widget);
