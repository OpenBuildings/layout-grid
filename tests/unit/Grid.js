$(function () {
    ...
    QUnit.test('getIntersectingRects', function () {
     ...
     * └─────────────┘    └─────────────┘
     */
    QUnit.test('compact method another configuration', function () {
     ...
     * └─────────────┘└─────────────┘
     */
    QUnit.test('updateNoOverlap method change width and height keeping position', function () {
     ...
     * └─────────────┘└─────────────┘
     */
    QUnit.test('updateNoOverlap method move with pushing down one element - 6', function () {
        var grid = new $.lt.Grid([
            new $.lt.Rect(0,0,4,3),
            new $.lt.Rect(4,0,3,3),
            new $.lt.Rect(10,0,3,6),
     ...
     * └─────────────┘└─────────────┘
     */
    QUnit.test('updateNoOverlap with pushing three element downward, 5, 4 and 7', function () {
        var grid = new $.lt.Grid([
            new $.lt.Rect(0,0,4,3),
            new $.lt.Rect(4,0,3,3),
            new $.lt.Rect(10,0,3,6),
     ...
     * └─────────────┘└─────────────┘
     */
    QUnit.test('updateNoOverlap with pushing two elements downward - 1 and 4', function () {
        var grid = new $.lt.Grid([
            new $.lt.Rect(0,0,4,3),
            new $.lt.Rect(4,0,3,3),
            new $.lt.Rect(10,0,3,6),
     ...
     * └─────────────┘└─────────────┘
     */
    QUnit.test('updateNoOverlap method move and resize an item, pushing down 6, 5 and 7', function () {
        var grid = new $.lt.Grid([
            new $.lt.Rect(0,0,4,3),
            new $.lt.Rect(4,0,3,3),
            new $.lt.Rect(10,0,3,6),
